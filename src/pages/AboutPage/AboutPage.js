...
const AboutPage = ({
    ...
    <div className='container'>
        <div id="aboutBanner" className="d-flex justify-content-between flex-wrap">
            <h1>蕭雨軒
                <span className="enVersion">Hsiao Yu-Hsin</span><br/>
                <span className="jpVersion">ショウ　ウケン</span>
            </h1>
            <h2><span className="jpVersion">An Artist / Interior Designer <br/>
                    based in Tokyo, Japan</span><br/>
                <span className="enVersion">アーティスト / インテリアデザイナー<br/>
                    東京､ 日本</span><br/>
            </h2>
        </div> 
        <div className="aboutCV">
            <div id="bio" className="cvBox">
                <h3>Bio</h3>
            ...
            <div id="education" className="cvBox">
                <h3>Education</h3>
            ...
            <div id="exhibitions" className="cvBox">
